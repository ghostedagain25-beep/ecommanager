...
const WebsiteForm: React.FC<WebsiteFormProps> = ({ website, onSave, onCancel, isSaving }) => {
  ...
  return (
    <form
      ...
      className="p-6 bg-gray-900/50 rounded-lg space-y-6 animate-fade-in"
    >
      <h3 className="text-xl font-semibold text-white">
        {isEditing ? `Editing ${website?.name}` : 'Add New Website'}
      </h3>
          ...
          <>
            <div className="md:col-span-2">
              ...
              <div className="flex items-center">
                <span className="text-gray-400 bg-gray-800 border border-r-0 border-gray-600 rounded-l-md px-3 py-2">
                  https://
                </span>
                <input
                  type="text"
                  ...
                  className="w-full block py-2 px-3 text-white bg-gray-700 border-y border-r border-gray-600 focus:ring-sky-500 focus:border-sky-500"
                />
                <span className="text-gray-400 bg-gray-800 border-y border-l-0 border-gray-600 rounded-r-md px-3 py-2">
                  .myshopify.com
                </span>
              </div>
              <p className="text-xs text-gray-400 mt-1">
                Enter just your store's handle, not the full URL.
              </p>
            </div>
            <div className="md:col-span-2">
