...
export const FileUploader: React.FC<FileUploaderProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      <div
        className={`relative flex flex-col items-center justify-center w-full h-48 border-2 ${borderColor} border-dashed rounded-lg cursor-pointer bg-gray-700/50 hover:bg-gray-700/80 transition-colors`}
      >
