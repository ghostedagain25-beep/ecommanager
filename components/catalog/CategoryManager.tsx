...
import { SpinnerIcon, ExclamationIcon, UserIcon, ArrowLeftIcon, WordPressIcon, PlusCircleIcon, SearchIcon, CheckCircleIcon, Trash2Icon, ShopifyIcon } from '../ui/icons';
        ...
        <div className="animate-fade-in space-y-6">
            ...
            {selectedWebsite.platform === 'shopify' ? (
                <div className="text-center py-10 bg-slate-900/50 rounded-lg">
                    ...
                    <p className="mt-1 text-sm text-gray-400">Category Management for Shopify stores is not yet supported.</p>
                </div>
            ) : (
                <>
