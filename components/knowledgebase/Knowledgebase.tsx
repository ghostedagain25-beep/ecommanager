...
export const Knowledgebase: React.FC = () => {
    ...
    const TabButton: React.FC<{ guide: Guide; label: string; icon: React.ReactNode }> = ({ guide, label, icon }) => {
    ...
    return (
        <div className="animate-fade-in">
            <header className="mb-8">
                ...
                <p className="text-lg text-gray-400 mt-2">Find guides and tutorials on how to connect and use the application.</p>
            </header>
