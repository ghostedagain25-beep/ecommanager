...
import type { SyncStatus, SyncResult, ChangesObject, SyncDetail, SyncPreviewData, ProductSyncChange } from '../types/sync';
...
import { WordPressIcon, SyncIcon, SpinnerIcon, CheckCircleIcon, ExclamationIcon, InfoIcon, EyeIcon, CancelIcon } from './icons';
...
export const WordPressSync: React.FC<WordPressSyncProps> = ({ processedData, user, website, onSyncSuccess }) => {
  ...
  }, [previewData, apiUrl, consumerKey, consumerSecret, username, processedData.length, onSyncSuccess, website]);
