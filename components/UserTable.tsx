...
const UserTable: React.FC<UserTableProps> = ({ users, onEdit, onDelete, onManageWebsites, onLoginAs, currentUser }) => {
  return (
    <>
      {/* Mobile Card View */}
        ...
        <table className="min-w-full divide-y divide-gray-700">
          <thead className="bg-gray-700/50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Manage Sites</th>
