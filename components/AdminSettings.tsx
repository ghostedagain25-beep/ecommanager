            ...
            <div className="max-w-2xl bg-gray-900/50 p-8 rounded-lg space-y-6">
                <div>
                    ...
                    <div className="mt-4 p-4 bg-gray-800 rounded-lg flex items-center justify-between">
                        ...
                        <label htmlFor="auto-login-toggle" className="inline-flex relative items-center cursor-pointer">
                            <input
                                type="checkbox"
                ...
                <div className="mt-6 flex items-start p-4 text-sm text-yellow-300 bg-yellow-900/50 border border-yellow-700 rounded-lg">
                    ...
                    <div>
                        <span className="font-semibold">Warning:</span> This is a temporary developer feature. Disabling this will require you to log in manually with the admin credentials ('admin' / 'eniac').
                    </div>
                </div>
            </div>
        </div>
